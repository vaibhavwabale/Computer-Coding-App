...
import in.icomputercoding.computercoding.databinding.ActivityCquizBinding;
...
public class CQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCquizBinding.inflate(getLayoutInflater());
        ...
        reference.child("CQuiz").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
                ...
                if (list.size() > 0) {
                    ...
                    binding.nextBtn.setOnClickListener(v -> {
                        ...
                        if (position == list.size()) {
                            Intent i = new Intent(CQuizActivity.this, ScoreActivity.class);
                    ...
                    Toast.makeText(CQuizActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CQuizActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void reverseTimer(TextView textView) {
        ...
        countDownTimer = new CountDownTimer((120 * 1000) + 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(CQuizActivity.this, ScoreActivity.class);
