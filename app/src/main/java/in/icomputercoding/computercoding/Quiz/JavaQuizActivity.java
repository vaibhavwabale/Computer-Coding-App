...
import in.icomputercoding.computercoding.databinding.ActivityJavaQuizBinding;
...
public class JavaQuizActivity extends AppCompatActivity {
    ...
    int position = 0;
    int count = 0;
    ActivityJavaQuizBinding binding;
    List<QuestionData> list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityJavaQuizBinding.inflate(getLayoutInflater());
