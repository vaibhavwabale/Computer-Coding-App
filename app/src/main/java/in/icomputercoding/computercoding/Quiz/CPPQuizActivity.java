...
import in.icomputercoding.computercoding.databinding.ActivityCppquizBinding;
...
public class CPPQuizActivity extends AppCompatActivity {
    ...
    int position = 0;
    int count = 0;
    ActivityCppquizBinding binding;
    List<QuestionData> list;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityCppquizBinding.inflate(getLayoutInflater());
        ...
        reference.child("CPPQuiz").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
                ...
                if (list.size() > 0) {
                    ...
                    binding.nextBtn.setOnClickListener(v -> {
                        ...
                        if (position == list.size()) {
                            Intent i = new Intent(CPPQuizActivity.this, ScoreActivity.class);
                    ...
                    Toast.makeText(CPPQuizActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(CPPQuizActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void reverseTimer(TextView textView) {
        ...
        countDownTimer = new CountDownTimer((120 * 1000) + 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(CPPQuizActivity.this, ScoreActivity.class);
