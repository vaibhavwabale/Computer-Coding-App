...
public class CPPScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cppscreen);

        pdfList = findViewById(R.id.PdfList);


        String[] pdfFiles = {"Chapter 1", "Chapter 2", "Chapter 3", "Chapter 4", "Chapter 5", "Chapter 6", "Chapter 7", "Chapter 8" , "Chapter 9"};
        ...
        pdfList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent i = new Intent(CPPScreen.this, PdfViewer.class);
            i.putExtra("CPPProgramming", item);
            startActivity(i);
        });
